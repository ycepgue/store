	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [(0, vue.createVNode)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({
				...
				"data-disabled",
				"disabled"
			]), (0, vue.unref)(isFormControl) && _ctx.name && !(0, vue.unref)(toggleGroupContext) ? ((0, vue.openBlock)(), (0, vue.createBlock)(require_VisuallyHidden_VisuallyHiddenInput.VisuallyHiddenInput_default, (0, vue.mergeProps)({
				key: 0,
				type: "checkbox",
				name: _ctx.name,
