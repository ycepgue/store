...
var TimeFieldInput_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		const { handleSegmentClick, handleSegmentKeydown, handleSegmentBeforeInput, handleSegmentCompositionStart, handleSegmentCompositionEnd, handleSegmentFocusOut, attributes } = require_date_useDateField.useDateField({
			hasLeftFocus,
			lastKeyZero,
