...
var DialogContentModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const ariaHiddenTarget = (0, vue.computed)(() => props.present ? currentElement.value : void 0);
		require_shared_useHideOthers.useHideOthers(ariaHiddenTarget);
		const forwardedProps = (0, vue.computed)(() => {
			const { present: _,...rest } = props;
			return rest;
		});
		(0, vue.watch)(() => props.present, (isPresent, wasPresent) => {
