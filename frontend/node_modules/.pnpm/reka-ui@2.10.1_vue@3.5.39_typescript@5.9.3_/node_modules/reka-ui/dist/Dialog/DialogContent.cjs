	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Presence_Presence.Presence_default), {
				...
				"force-mount": _ctx.forceMount || !(0, vue.unref)(rootContext).unmountOnHide.value
			}, {
				default: (0, vue.withCtx)(({ present }) => [(0, vue.unref)(rootContext).modal.value ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(require_Dialog_DialogContentModal.DialogContentModal_default, (0, vue.mergeProps)({
					...
					present: (0, vue.unref)(rootContext).unmountOnHide.value || present
				}, {
					...props,
					...
					_: 2
				}, 1040, ["present"])), [[vue.vShow, (0, vue.unref)(rootContext).unmountOnHide.value || present]]) : (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(require_Dialog_DialogContentNonModal.DialogContentNonModal_default, (0, vue.mergeProps)({
					key: 1,
					ref: (0, vue.unref)(forwardRef),
					present: (0, vue.unref)(rootContext).unmountOnHide.value || present
				}, {
					...
					default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "default")]),
					_: 2
				}, 1040, ["present"])), [[vue.vShow, (0, vue.unref)(rootContext).unmountOnHide.value || present]])]),
				_: 3
