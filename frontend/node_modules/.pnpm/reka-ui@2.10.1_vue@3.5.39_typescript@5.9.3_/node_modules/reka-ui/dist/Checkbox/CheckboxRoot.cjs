...
var CheckboxRoot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)((0, vue.unref)(checkboxGroupContext)?.rovingFocus.value ? (0, vue.unref)(require_RovingFocus_RovingFocusItem.RovingFocusItem_default) : (0, vue.unref)(require_Primitive_Primitive.Primitive)), (0, vue.mergeProps)({
				..._ctx.$attrs,
				...
				"focusable",
				"onKeydown"
			])), (0, vue.unref)(isFormControl) && _ctx.name && !(0, vue.unref)(checkboxGroupContext) ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_VisuallyHidden_VisuallyHiddenInput.VisuallyHiddenInput_default), (0, vue.mergeProps)({
				key: 0,
				type: "checkbox",
