...
function useDrawerSnapPoints(options) {
	...
	const viewportHeight = (0, vue.ref)(typeof window !== "undefined" ? window.innerHeight : 0);
	const rootFontSize = (0, vue.ref)(typeof document !== "undefined" ? Number.parseFloat(getComputedStyle(document.documentElement).fontSize) || 16 : 16);
	if (typeof window !== "undefined") (0, __vueuse_core.useEventListener)(window, "resize", () => {
		viewportHeight.value = window.innerHeight;
	});
	const resolvedSnapPoints = (0, vue.computed)(() => {
	...
	*/
	...
	const activeSnapPointOffset = (0, vue.computed)(() => findActiveResolvedPoint()?.offset ?? null);
	/**
...
//#endregion
Object.defineProperty(exports, 'useDrawerSnapPoints', {
  enumerable: true,
  get: function () {
    return useDrawerSnapPoints;
  }
});
//# sourceMappingURL=useDrawerSnapPoints.cjs.map