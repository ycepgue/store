...
var PopperContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const dir = require_shared_useDirection.useDirection((0, vue.computed)(() => props.dir));
		...
		const computedMiddleware = (0, vue.computed)(() => {
			return [
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
			...
			}, [props.memoDependencies ? (0, vue.withMemo)([
				props.asChild,
				props.as,
				placedSide.value,
				placedAlign.value,
				(0, vue.unref)(isPositioned),
				...Object.values(_ctx.$attrs),
				...props.memoDependencies
			], () => ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({
				key: 0,
				...
				"data-align",
				"style"
			])), _cache, 0) : ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({
				key: 1,
				ref: (0, vue.unref)(forwardRef)
			}, _ctx.$attrs, {
				"as-child": props.asChild,
