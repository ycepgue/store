...
const Drawer = {
  Root: rekaUi.DrawerRoot,
  Trigger: rekaUi.DrawerTrigger,
  Portal: rekaUi.DrawerPortal,
  Overlay: rekaUi.DrawerOverlay,
  Content: rekaUi.DrawerContent,
  Close: rekaUi.DrawerClose,
  Title: rekaUi.DrawerTitle,
  Description: rekaUi.DrawerDescription,
  Handle: rekaUi.DrawerHandle,
  SwipeArea: rekaUi.DrawerSwipeArea,
  Viewport: rekaUi.DrawerViewport,
  Indent: rekaUi.DrawerIndent,
  IndentBackground: rekaUi.DrawerIndentBackground
};
const DropdownMenu = {
...
const Rating = {
  Root: rekaUi.RatingRoot,
  Item: rekaUi.RatingItem,
  ItemIndicator: rekaUi.RatingItemIndicator
};
const ScrollArea = {
