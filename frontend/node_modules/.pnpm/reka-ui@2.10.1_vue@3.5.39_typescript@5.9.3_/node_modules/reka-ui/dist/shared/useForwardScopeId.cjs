...
function useForwardScopeId() {
	const scopeId = ((0, vue.getCurrentInstance)()?.vnode)?.scopeId;
	return scopeId ? { [scopeId]: "" } : {};
}

//#endregion
Object.defineProperty(exports, 'useForwardScopeId', {
  enumerable: true,
  get: function () {
    return useForwardScopeId;
  }
});
//# sourceMappingURL=useForwardScopeId.cjs.map