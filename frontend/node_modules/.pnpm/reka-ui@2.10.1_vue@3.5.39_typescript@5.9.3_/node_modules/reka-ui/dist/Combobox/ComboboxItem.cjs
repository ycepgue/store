...
var ComboboxItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return isRender.value ? (0, vue.withMemo)([
				isRender.value,
				(0, vue.unref)(rootContext).filterSearch.value,
				(0, vue.unref)(rootContext).disabled.value,
				_ctx.disabled,
				props.value,
				props.as,
				props.asChild,
				...Object.values(_ctx.$attrs)
			], () => ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Listbox_ListboxItem.ListboxItem_default), (0, vue.mergeProps)({ key: 0 }, props, {
				id: (0, vue.unref)(id),
				...
				_: 3
			}, 16, ["id", "disabled"])), _cache, 1) : (0, vue.createCommentVNode)("v-if", true);
		};
	}
});
