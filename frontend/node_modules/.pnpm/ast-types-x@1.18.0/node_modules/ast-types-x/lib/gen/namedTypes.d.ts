...
export declare namespace namedTypes {
    ...
    interface PrivateIdentifier extends Omit<Expression, "type">, Omit<Pattern, "type"> {
    ...
    interface PropertyDefinition extends Omit<ClassProperty, "type"> {
    ...
    let PrivateIdentifier: Type<PrivateIdentifier>;
